...
{
    switch (unit) {
    case Unit::BTC: return QString("BC3");
    case Unit::mBTC: return QString("mBC3");
    case Unit::uBTC: return QString::fromUtf8("µBC3 (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("BitcoinIII");
    case Unit::mBTC: return QString("Milli-BitcoinIII (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-BitcoinIII (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
